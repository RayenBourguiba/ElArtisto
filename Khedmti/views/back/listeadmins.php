...
<input type="submit" class="btn btn-primary"  value="Chercher">
                        ...
                        $adh=new adhC();
                        $listeadmins=$adh->afficheradmin();
                       // $listeadmins=$adh->sortv();
                        ?>
                        <?php
                        // pagination 
...
$listeadmins = $adh->AffichermPagineradmin($page, $perpage);
$totalP = $adh->calcTotalRowsadmin($perpage);
                        ...
                        $listeadmins= $adh->rechercheadmin($search_value);
                        }
                        ?>
                        <div class="form-group">
<form method="get" action="listeadmins.php"  class="mb-4">-->
...
<form method="POST" action="listeadmins1.php">
