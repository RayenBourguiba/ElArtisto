      ...
      <div class="icon"><img src="../wp-content/uploads/2021/03/title-shape.png" alt="Commandes"></div>
		...
		<form class="d-none d-sm-inline-block" action="" method="POST">
          <div class="input-group input-group-navbar">
            ...
            <a href="afficherCommande.php" class="btn btn-info">Reload</a>
          </div>
        </form>
        ...
        <body>
		<br>
		<table id="Tl" class="table table-hover my-0" >

                  <button><a href="ajouterCommande.php">Retour à l'ajout</a></button>
                  <?php
				...
				<th>Creer PDF</th>
                      ...
                      <tbody>
                        ...
                        $query = $db->prepare("SELECT * FROM commande WHERE id LIKE '%$keyword%' or nom_produit LIKE '%$keyword%' or quantite LIKE '%$keyword%' or prix_total LIKE '%$keyword%' or modeP Like '%$keyword%' ");
                        $query->execute();
				...
				<th>Creer PDF</th>
                   ...
                   foreach($listeUsers as $user){
                    ...
                    <tr>
                      ...
                      <td><?PHP echo $user['nom_produit']; ?></td>
                      <td><?PHP echo $user['quantite']; ?></td>
                      <td><?PHP echo $user['prix_total']; ?></td>
                      <td><?PHP echo $user['modeP']; ?></td>
                      <td>
