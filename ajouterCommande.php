        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input class="form-control" type="text" name="nom_produit" id="nom_produit" maxlength="20"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input class="form-control" type="int"  name="quantite" id="quantite" pattern="[0-9]+"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-control" type="double" name="prix_total" id="prix_total" pattern="[0-9]+" >
                    </td>
                </tr>
