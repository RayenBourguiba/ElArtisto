                                ...
                                <div class="row no-gutters">
                                    <div class="col-lg-5">
                                        <div class="post-preview-featured-img"
                                             style='background-image: url("./includes/img/<?php echo $post_image; ?>")'></div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="card-body">
                                            <div class="py-5">
                                            ...
                                            <div class="post-preview-meta">
                                                <img class="post-preview-meta-img" src="./includes/img/<?php echo $post_image; ?>"/>
                                ...
                                while ($posts = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    <div class="col-md-6 col-xl-4 mb-5">
                                        <a class="card post-preview lift h-100"
                                           href="single.php?post_id=<?php echo $post_id; ?>"
                                        ><img class="card-img-top" src="./includes/img/<?php echo $post_image; ?>"
