...
<?php
    ...
    isset($_POST["telephone"])  
		...
		if (          
            ...
            header('refresh:5;url=afficherlivraisons.php');
        }
        else
      ...
      <div class="icon"><img src="../wp-content/uploads/2021/03/title-shape.png" alt="Commandes"></div>
        ...
        <tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="adresse" id="adresse" maxlength="20" value = "<?php echo $user['adresse']; ?>">
					</td>
				</tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="telephone" name="telephone" id="telephone" value = "<?php echo $user['nom']; ?>">
                    </td>
                </tr>
