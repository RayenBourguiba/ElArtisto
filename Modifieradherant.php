...
include  "../../entity/adhs.php";
include  "../../controller/ajouterAdh.php";
if(isset($_GET["id"]))
{
$adh=new adhC();
$result=$adh->recupereradh($_GET["id"]);
                ...
                <form method="post" >
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>  mdp<span class="text-danger">*</span></label>
                            <input class="form-control" type="number" name="mdp">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label> prenom </label>
                            <textarea class="form-control" type="text" name="prenom"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label> email </label>
                            <textarea class="form-control" type="email" name="email"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label> tel </label>
                            <textarea class="form-control" type="number" name="tel"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label> typead </label>
                            <textarea class="form-control" type="text" name="typead"></textarea>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label> prof </label>
                            <textarea class="form-control" type="text" name="prof"></textarea>
                        </div>
                    </div>
