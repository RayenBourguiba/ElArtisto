...
include_once '../controllers/BoostC.php';
    ...
    $boostc = new BoostC();
if (isset($_POST["type"]) && isset($_POST["nombre"]))
{  
if (!empty($_POST["type"]) && !empty($_POST["nombre"])) 
{
$boost = new Boost($_POST['type'], $_POST['nombre']);
$boostc->ajouterBoost($boost,$_GET['id']);
                ...
                <div class="col-lg-4">
                    <aside class="sidebar widget-area">
                        <div id="search-2" class="widget widget_search">
                            <h6 class="widget-title">Booster</h6>
                            ...
                            <label>
                                ...
                                <input type="submit" class="search-submit" value="Booster" name="Booster" />
                                <p></p>
                                <p><strong>Boost première position :</strong> votre annonce remonte à la première position, vous assurant des ventes beaucoup plus rapides.</p>
                                <p><strong>Annonce à la une :</strong> faites de votre produit le produit Star présent sur la première page.</p>
