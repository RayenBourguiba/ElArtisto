...
$anExhb = new anExhibition();
if ( isset($_POST["title"]) && isset($_POST["datee"]) && isset($_POST["emplacement"]) && isset($_POST["heure"]) && isset($_POST["categorie"]) && isset($_POST["prix_ticket"])  && isset($_POST["nplaces"]))
{
if (!empty($_POST["title"]) && !empty($_POST["datee"]) && !empty($_POST["emplacement"]) && !empty($_POST["heure"]) && !empty($_POST["categorie"]) && !empty($_POST["prix_ticket"]) && !empty($_POST["categorie"]) && !empty($_POST["nplaces"]))
{
$exhb = new exhibition( $_POST['title'], $_POST['datee'], $_POST['emplacement'], $_POST['heure'], $_POST['categorie'], $_POST['prix_ticket'],$_SESSION['user_nickname'],$_POST["nplaces"]);
$anExhb->ajouterExhibition($exhb);
...
<!--            <div class="navbar-button"><a href="./visit.html">SIGN UP</a></div>-->
      ...
      <path id="svg_morph" d="m261,30.4375c0,0 114,6 151,75c37,69 37,174 6,206.5625c-31,32.5625 -138,11.4375 -196,-19.5625c-58,-31 -86,-62 -90,-134.4375c12,-136.5625 92,-126.5625 129,-127.5625z" />
                        ...
                        <h1>HOST AN EXHIBITION</h1>
                        <p>Now you can host your exhibition DO NOT forget to carefully fill the form down below..
                            ...
                            <div class="col-lg-4">
                                <aside class="sidebar widget-area">
                                    <div id="search-2" class="widget widget_search">
                                        <h6 class="widget-title">HOST AN EXHIBITION</h6>
                                        <form role="search" method="POST" class="search-form" action=""  >
                                            <label>Title:</label>
                                            <input type="text" class="search-field" placeholder="Title &hellip;" value="" name="title" id="title" />

                                            <label>Full Adress:</label>
                                            <textarea type="text" cols="40" rows="6" class="search-field" placeholder="Full Address &hellip;" value="" name="emplacement" id="emplacement"></textarea>
                                            ...
                                            <input type="time" class="dateClass" placeholder="Starting Time &hellip;" value="19:00" name="heure" id="heure" />

                                            <label>Category:</label>
                                            <select name="categorie" id="categorie" class="form-control">
                                                <option value="Photography">Photography</option>
                                                <option value="Metal Arts Sculpture">Metal Arts Sculpture</option>
                                                <option value="Painting">Painting</option>
                                                <option value="Specialty Art">Specialty Art</option>
                                                <option value="Advanced Art">Advanced Art</option>
                                            </select>

                                            <label>Ticket Price:</label>
                                            <input type="number" class="search-field" placeholder="Ticket Price DT &hellip;" value="" name="prix_ticket" id="prix_ticket" />

                                            <label>Places Available:</label>
                                            <input type="number" class="search-field" step="1" placeholder="0" value="" name="nplaces" id="nplaces" min="0" />

                                            <input type="submit" class="search-submit" value="Submit" name="submit"  />
