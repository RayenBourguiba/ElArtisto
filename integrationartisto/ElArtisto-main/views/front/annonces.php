                ...
                <ul id="menu-main-menu-1" class="nav-menu">
                    ...
                    <li itemscope="itemscope" itemtype=""
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-456 nav-item"><a
                                ...
                                data-text="Contact">Profile</a><i></i></li> <?php } ?>
                </ul>
            </div>
...
<?php if(isset($_SESSION['user_id'])){ ?><div class="navbar-button"> <a href="form_annonce.php">CREER UNE ANNONCE</a> </div><?php } ?>
            <?php
                        ...
                        ?>
                                <div class="col-lg-4 col-md-6">
                                    <div class="collection-box" data-scroll data-scroll-speed="0">
                                        ...
                                        <a href="annonce.php?id=<?PHP echo $Annonce['id']; ?>"><h4><?PHP echo $Annonce['nom']; ?></h4></a>
