...
$listExhibitions = $Exhb->AfficherPaginer($page, $perpage);
$totalP = $Exhb->calcTotalRows($perpage);
                    ...
                    <div class="col-lg-8" id="bigDiv">
                        ...
                        <?php foreach ($listExhibitions as $exhibition) {
                            if ($exhibition['status'] == "approved") {   ?>
                                ...
                                <div id="post-421" class="blog-post post-421 post type-post status-publish format-standard has-post-thumbnail hentry category-art-galleries category-exhibitions category-membership" <?php if ($exhibition['status'] == "pending") {
                                                                                                                                                                                                                            echo "style=background-color:#E0E0E0";
                                                                                                                                                                                                                        } ?>>
                                    <div class="post-content"> <?php if ($exhibition['status'] == "pending") {
                                                                    echo "<h6 style=color:red >Pending</h6>";
                                                                } ?>
                                        <small class="date">

                                            <?php echo $exhibition['datee'];
                                            echo '&nbsp at &nbsp';
                                            echo $exhibition['heure'];
                                            echo '&nbsp in &nbsp';
                                            echo $exhibition['emplacment'];    ?></small>
                                        ...
                                        <div class="author post-author">
                                            <a class="author-link-thumb" href="exhibitionProfile.php?username=<?php echo $exhibition['host'];  ?>"><img src="../../assets/img/title-shape.png" alt="L'Artisto"></a> <span> by <a class="author-link" href="exhibitionProfile.php?username=<?php echo $exhibition['host'];  ?>"><strong><?php echo $exhibition['host'];    ?></strong></a></span>
                                        </div>
                                        <br><small>
                                            <h6><?php echo ($exhibition['nplaces'] - $exhibition['ticketsReserved']); ?> Places Left <?php if ((($exhibition['nplaces'] - $exhibition['ticketsReserved']) != 0) && $exhibition['status'] == "approved") { ?><a class="date" id="theID" href="payment.php?id=<?php echo $exhibition['id']; ?>">Get Your Ticket</a><?php } ?></h6>
                                        </small>
                                    </div>
