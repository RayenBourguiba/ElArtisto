...
<h1 align = 'center' class="page-title">Ajouter livreur</h1>
</div>
...
<input type="int" class="form-control" name="tel" id="tel" placeholder="Téléphone">
</div>
<div class="form-group">
...
<input type="submit" class="btn btn-common mr-3" value="Envoyer"> 
